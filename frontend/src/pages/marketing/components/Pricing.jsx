  ...
  const plans = [
    {
      ...
      monthlyPrice: 99,
      yearlyPrice: 79,
      desc: "For standalone culinary bistros requiring robust basic seating management.",
      features: [
    ...
    },
    {
      ...
      monthlyPrice: 199,
      yearlyPrice: 159,
      desc: "For high-volume, multi-room dining lounges requiring live team dispatch.",
      features: [
    ...
    },
    {
      ...
      monthlyPrice: 399,
      yearlyPrice: 319,
      desc: "For global hospitality groups requiring dedicated resources and customized routing.",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-6 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-[#F5F0EB]">
            Transparent structures built for business growth.
          </h2>
          ...
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="border-y border-white/5 py-6">
                  ...
                  <div className="text-[10px] text-[var(--color-text-muted)] font-mono mt-2 uppercase tracking-wide">
                    {billingCycle === 'yearly' ? `Billed annually ($${plan.yearlyPrice * 12}/yr)` : 'Billed month-to-month'}
                  </div>
                </div>
              ...
              <div className="mt-8">
                {plan.name === 'Gold Plan' ? (
                  <a
                    href="mailto:sales@tableos.agency?subject=TableOS%20Gold%20Plan%20Inquiry"
                    className="w-full block py-4 text-center rounded font-semibold text-sm transition-all border border-white/15 bg-white/5 text-[#F5F0EB] hover:bg-white/10 hover:border-white/20 active:scale-95"
                  >
                    {plan.cta}
                  </a>
                ) : (
